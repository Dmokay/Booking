                                        ...
                                        <div class="card-body">
                                            ...
                                            <div>
                                                <ul class="nav nav-tabs tab-no-active-fill" role="tablist">
                                                    <li class="nav-item">
                                                        <a class="nav-link active pl-2 pr-2" id="revenue-for-last-month-tab" data-toggle="tab" href="{{url('#revenue-for-last-month')}}" role="tab" aria-controls="revenue-for-last-month" aria-selected="true">Revenue for last month</a>
                                                    </li>
                                                    <li class="nav-item">
