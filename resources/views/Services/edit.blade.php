                            ...
                            <div class="card-body">
                                ...
                                <form class="forms-sample" action="{{route('services.update', $service->id)}}" method="post">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="number" class="form-control form-control-sm" required name="upper_deck" value="{{$service->upper_deck}}"
                                               placeholder="Max Attendees">
                                    </div>
                                    <div class="form-group">
                                        <label for="exampleInputUsername1">Max Attendees on Lower Deck*</label>
                                        <input type="number" class="form-control form-control-sm" required name="lower_deck" value="{{$service->lower_deck}}"
                                               placeholder="Max Attendees">
                                    </div>
                                    <div class="form-group">
